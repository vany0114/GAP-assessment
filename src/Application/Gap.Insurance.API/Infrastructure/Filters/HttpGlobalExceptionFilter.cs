...
using Gap.Insurance.API.Infrastructure.ActionResults;
    ...
    public class HttpGlobalExceptionFilter : IExceptionFilter
    {
        ...
        public void OnException(ExceptionContext context)
        {
            ...
            if (context.Exception.GetType() == typeof(CustomerDomainException) || 
                context.Exception.GetType() == typeof(InsuranceDomainException) ||
                context.Exception.GetType() == typeof(CustomerApplicationArgumentNullException) ||
                context.Exception.GetType() == typeof(InsuranceApplicationArgumentNullException))
            {
